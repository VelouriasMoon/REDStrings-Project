...
#include "HorizonUIPlugin/Public/EHorizonUIInputMode.h"
#ifdef _MSC_VER
#pragma warning (push)
#pragma warning (disable : 4883)
#endif
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeEHorizonUIInputMode() {}
...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_HorizonUI_EHorizonUIInputMode_Hash() { return 2495959899U; }
	UEnum* Z_Construct_UEnum_HorizonUI_EHorizonUIInputMode()
	{
		...
		if (!ReturnEnum)
		{
			...
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "ModuleRelativePath", "Public/EHorizonUIInputMode.h" },
