...
#include "HorizonUIPlugin/Public/EHorizonDialogueTextOverflowWarpMethod.h"
#ifdef _MSC_VER
#pragma warning (push)
#pragma warning (disable : 4883)
#endif
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeEHorizonDialogueTextOverflowWarpMethod() {}
...
// End Cross Module References
	...
	template<> HORIZONUI_API UEnum* StaticEnum<EHorizonDialogueTextOverflowWarpMethod>()
	{
		return EHorizonDialogueTextOverflowWarpMethod_StaticEnum();
	}
	...
	uint32 Get_Z_Construct_UEnum_HorizonUI_EHorizonDialogueTextOverflowWarpMethod_Hash() { return 3033259957U; }
	UEnum* Z_Construct_UEnum_HorizonUI_EHorizonDialogueTextOverflowWarpMethod()
	{
		...
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EHorizonDialogueTextOverflowWarpMethod"), 0, Get_Z_Construct_UEnum_HorizonUI_EHorizonDialogueTextOverflowWarpMethod_Hash(), false);
#else
		...
		if (!ReturnEnum)
		{
			...
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				{ "BlueprintType", "true" },
				{ "BreakAll.Name", "EHorizonDialogueTextOverflowWarpMethod::BreakAll" },
				{ "ModuleRelativePath", "Public/EHorizonDialogueTextOverflowWarpMethod.h" },
				{ "Normal.Name", "EHorizonDialogueTextOverflowWarpMethod::Normal" },
			};
#endif
